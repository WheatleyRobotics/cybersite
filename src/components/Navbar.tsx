      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link href="/" className="text-white hover:text-red-500  font-mono text-sm">
              HOME
            </Link>
            <a href="/about" className="text-white hover:text-red-500  font-mono text-sm">
              ABOUT
            </a>
            <a href="/robot" className="text-white hover:text-red-500  font-mono text-sm">
              ROBOTS
            </a>
            ...
            <a href="/contact" className="text-white hover:text-red-500  font-mono text-sm">
              CONTACT
            </a>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/95 border-t border-red-500/20">
              <Link href="/" className="block px-3 py-2 text-white hover:text-red-500  font-mono text-sm">
                HOME
              </Link>
              <a href="/about" className="block px-3 py-2 text-white hover:text-red-500  font-mono text-sm">
                ABOUT
              </a>
              ...
              <a href="/contact" className="block px-3 py-2 text-white hover:text-red-500  font-mono text-sm">
                CONTACT
              </a>
            </div>
          </div>
